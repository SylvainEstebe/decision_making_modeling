"""Fit the hierarchical CC model with the *experience* covariate."""
...
def main() -> None:
    ...
    add_common_args(parser, default_label="experience")
    args = parser.parse_args()

    ds = load_public_goods_data(args.data, covariate="experience")
    ...
    plot_country_means(
        ...
        covariate_label="National experience-of-harm index (Lloyd's Register 2021)",
    )
